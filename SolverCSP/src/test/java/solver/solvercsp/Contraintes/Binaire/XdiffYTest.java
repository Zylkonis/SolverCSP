...
class XdiffYTest {
    ...
    @Test
    void evaluate1() {
        Variable varX1 = new Variable("x", new IntDomaine(1, 1));
        ...
        assertEquals(varY1.getDomaine().getDomain(), new IntDomaine(2, 10).getDomain(), "erreur: XdiffY cont1 Domaine y incorrecte");
        assertNotEquals(varX1.getDomaine().getDomain(), varY1.getDomaine().getDomain(), "erreur: XdiffY cont1 Domaine y incorrecte");
    }

    @Test
    void evaluate2() {
        Variable varX2 = new Variable("x", new IntDomaine(1, 10));
        Variable varY2 = new Variable("y", new IntDomaine(1, 1));
        ...
        assertEquals(varX2.getDomaine().getDomain(), new IntDomaine(2, 10).getDomain(), "erreur: XdiffY cont2 Domaine x incorrecte");
        assertNotEquals(varX2.getDomaine().getDomain(), varY2.getDomaine().getDomain(), "erreur: XdiffY cont2 Domaine x incorrecte");
    }

    @Test
    void evaluate3() {
        Variable varX3 = new Variable("x", new IntDomaine(1, 1));
        Variable varY3 = new Variable("y", new IntDomaine(1, 1));
    ...
    @Test
    void evaluate4() {
        Variable varX1 = new Variable("x", new IntDomaine(0, 0));
        Variable varY1 = new Variable("y", new IntDomaine(1, 10));
        ...
        assertEquals(varY1.getDomaine().getDomain(), new IntDomaine(1, 10).getDomain(), "erreur: XdiffY cont1 Domaine y incorrecte");
        assertNotEquals(varX1.getDomaine().getDomain(), varY1.getDomaine().getDomain(), "erreur: XdiffY cont1 Domaine y incorrecte");
    }
