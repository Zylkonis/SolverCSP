...
class AllDifferentTest {
    ...
    {
        //Les domaines sont identiques et de cardinalité 1 : on doit avir une Exception
        Variable testNull1 = new Variable("testNull1", new IntDomaine(1,1));
        Variable testNull2 = new Variable("testNull2", new IntDomaine(1,1));
        Variable testNull3 = new Variable ("testNull3", new IntDomaine(2,2));
